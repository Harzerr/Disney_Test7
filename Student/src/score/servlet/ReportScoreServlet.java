...
public class ReportScoreServlet extends HttpServlet {
	...
	private final TeacherImpl teacherImpl = new TeacherImpl();
	private final ScoreImpl scoreImpl = new ScoreImpl();
	private final ClassesImpl classesImpl=new ClassesImpl();
